...
\subsection*{Useful Powershell Commands}
...
\cmd{\linux}{failog -r -u \emph{username}}
...
\item \url{http://www.robvanderwoude.com/ntadmincommands.php}
\item \url
{http://pubs.vmware.com/vsphere-50/topic/com.vmware.ICbase/PDF/vsphere-esxi-vcenter-server-50-security-guide.pdf}
\end{itemize}

\section*{Very Useful Downloads}
\begin{itemize}
\small
\item {Sys Internals:} \url{http://technet.microsoft.com/en-us/sysinternals/bb842062}
